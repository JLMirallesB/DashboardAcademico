 ...
 * Navegación de las vistas principales, con sus iconos
 */
...
const views = [
  ...
  /* Las dos vistas del 23/08/2026. «Alertas» va junto a «Dificultad» porque es
     la misma pregunta mirada a lo largo del curso, y «Familias» al final,
     antes de los datos en crudo. */
  { id: 'alertas', labelKey: 'alrTitulo' },
  { id: 'familias', labelKey: 'fam_titulo' },
