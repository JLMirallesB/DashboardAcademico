/* Núcleo — de las filas del CSV a la estructura que se consulta
 *
 * Sin React. Aquí se decide la CLAVE con la que vive cada fichero cargado:
 * evaluación + etapa, «1EV-EEM». La etapa no viene escrita en el CSV, se
 * deduce mirando los niveles que trae, porque cada fichero es de una sola
